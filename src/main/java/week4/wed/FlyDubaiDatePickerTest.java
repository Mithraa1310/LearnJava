...
public class FlyDubaiDatePickerTest {
    ...
    public void datePickerTest() {
        ...
        WebElement dateWidgetFrom = driver.findElement(By.xpath("//span[@class='date-view']//i"));
        driver.findElement(By.xpath("//span[@class='date-view']//i")).click();
      //span[@class='date-view']//span//i
